namespace :paperclip do
  ...
  task :move_attachments => :environment do
    ...
    Post.find_each do |post|
      unless post.pic_file_name.blank?
        #filename = Rails.root.join('public', 'system', 'images', post.id.to_s, 'original', post.pic_file_name)
        filename = 'public' + 'system' + 'pics' + post.id.to_s + post.pic_file_name
